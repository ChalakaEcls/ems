                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('student.register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="nic_number" class="col-md-4 col-form-label text-md-end">NIC Number</label>
                                <div class="col-md-6">
                                    <input id="nic_number" type="text" class="form-control @error('nic_number') is-invalid @enderror" name="nic_number" value="{{ old('nic_number') }}" required>
                                    @error('nic_number')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
